        ...
        <div class="page-title-heading">
          ...
          <div>
            ...
            <div class="page-title-subheading">
              Wide selection of forms controls, using the Bootstrap 4 code base,
              but built with React.
            </div>
          </div>
        </div>
            ...
            <div class="main-card mb-3 card">
              <div class="card-body">
                ...
                <form class="">
                  ...
                  <div class="position-relative form-group">
                    <label for="exampleSelectMulti" class=""
              ...
              <div class="main-card mb-3 card">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="position-relative form-group">
                        <label for="exampleCustomSelectDisabled" class=""
                      ...
                      <div class="position-relative form-group">
                        <label
                          ...
                          class=""
                          >Custom Multiple Select Disabled</label
                        ><select
                          multiple=""
                          type="select"
